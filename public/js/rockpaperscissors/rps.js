...
function finalResults(){
    ...
    if(wins === 0){
        gameArea.innerHTML = '<div id="prompt"><h2>You tied the computer!</h2></div>'+
            ...
            '                 </div><div id="options"><h3>CPU moves:</h3><img class="result" src="/assets/rockpaperscissors/'+aiOptions[0]+'.png"><img class="result" src="/assets/rockpaperscissors/'+aiOptions[1]+'.png"><img class="result" src="/assets/rockpaperscissors/'+aiOptions[2]+'.png"><img class="result" src="/assets/rockpaperscissors/'+aiOptions[3]+'.png"><img class="result" src="/assets/rockpaperscissors/'+aiOptions[4]+'.png"><img class="result" src="/assets/rockpaperscissors/'+aiOptions[5]+'.png"><img class="result" src="/assets/rockpaperscissors/'+aiOptions[6]+'.png"><img class="result" src="/assets/rockpaperscissors/'+aiOptions[7]+'.png"><img class="result" src="/assets/rockpaperscissors/'+aiOptions[8]+'.png"><img class="result" src="/assets/rockpaperscissors/'+aiOptions[9]+'.png"></div>' +
