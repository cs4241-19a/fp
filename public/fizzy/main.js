// https://bl.ocks.org/tophtucker/raw/978513bc74d0b32d3795/
// https://workshop.chromeexperiments.com/examples/gui/#1--Basic-Usage
// https://davidwalsh.name/demo/dat-gui.php
function FizzyText(message) {
    ...
    switch (document.title) {
        ...
        case 'Modify Profile':
            s.font = g.font = "400 65px helvetica, arial, sans-serif"
            break
        case 'Overview':
        case 'Favorite':
        case 'Black List':
            s.font = g.font = "600 85px helvetica, arial, sans-serif"
            break
        case 'Profile':
            s.font = g.font = "400 65px helvetica, arial, sans-serif"
            break
