...
export declare interface ChatboxOptions {
     ...
     * translation for all conversations, or you can pass an array of {@link ConversationBuilder}s or conversation Ids to be translated.
     * This feature is only available on the premium plan and up. Make sure you add your Google API key in the dashboard.
     */
    translateConversations?: boolean | string[] | ConversationBuilder[];
    /**
...
export declare interface UIBox {
     ...
     * @param enabled - Whether conversations should be translated by default or not.
     */
    setTranslationEnabledDefault(enabled: boolean): void;
}
